<?php
$themename = "Creative Porfolio";
$shortname = "unit_theme";
$settings_list = array(
    'custom_logo_url',
    'featured_text',
...
<tr>
  ...
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (170px wide x 50px high)</small></td>
</tr>
<tr>
